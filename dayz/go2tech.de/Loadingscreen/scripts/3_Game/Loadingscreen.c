modded class LoadingScreen {
	...
	void LoadingScreen(DayZGame game) {
		...
		m_ImageBackground.LoadImageFile(0, "Loadingscreen/data/G2T_Loadingscreen.edds");
...
modded class LoginQueueBase {
	...
	override Widget Init() {
		...
		imageWidgetBackground.LoadImageFile(0, "Loadingscreen/data/G2T_Loadingscreen.edds");
		return w;
	}
}
